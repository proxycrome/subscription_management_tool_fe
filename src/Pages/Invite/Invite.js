    ...
    <>
      <div className="webmobile-invite-view">
        <div className="web-invite-view">
          <DashFrame
            dashinvitestyle={{ backgroundColor: presentcolor.dashinvitecolor }}
          >
                ...
                <form>
                  ...
                  >
                    ...
                    <label className="phone-label">
                      Enter email or phone number of contact
                    </label>
                    ...
                    <div className="textarea-div">
                      <textarea className="textarea">
                        Flex is a subscription management platform that allows
                        you to mange multiple subscription plans.it gives you
                        the freedom to control and keep track of your expenses.
                      </textarea>
                    </div>
                    <div className="phone-input-invite-div">
                    ...
                    <div className="phone-input-invite-div">
                      <input
                        type="text"
                        placeholder="https://bit.ly?exgO9fdjhjgh"
                        className="input-fld"
                      />
                    </div>
                  </div>
            ...
            <div className="inner-settings-sectionrx">
              ...
              <form>
                ...
                >
                  ...
                  <div className="textarea-div">
                    <textarea className="textarea">
                      Flex is a subscription management platform that allows you
                      to mange multiple subscription plans.it gives you the
                      freedom to control and keep track of your expenses.
                    </textarea>
                  </div>
                  <button type="submit" className="invite-button">
                    SEND INVITE
