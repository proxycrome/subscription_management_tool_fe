    ...
    <>
      <div className="webmobile-frequent-view">
        <div className="web-frequent-view">
          <DashFrame
            dashSupportStyle={{ backgroundColor: presentcolor.dashheadercolor }}
          >
            <div className="inner-settings-section">
              ...
              >
                ...
                <select className="questions">
                  <option>
                    Q2. How secure is my E-Wallet account on Flex?
                  </option>
                </select>
                <select className="questions">
                  <option>
                    Q3. Can I check my subscription history on Flex?
                  </option>
                </select>
                <select className="questions">
                ...
                <select className="questions">
                  <option>
                    Q6. Can I subscribe to more than one product on Flex?
                  </option>
                </select>
                <select className="questions">
                ...
                <select className="questions">
                  <option>
                    Q9. How can I learn more about products and services?
                  </option>
                </select>
                <select className="questions">
