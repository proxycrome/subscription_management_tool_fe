...
function Newsub({
  ...
  useEffect(() => {
    ...
    axios.get(`${baseURL}/users/category`).then((res) => {
      console.log(res);
      ...
      if (names == "Playstation") {
        ...
        packageFileorigin.map((val, index) => {
          ...
          //  setPackageFiles(packageFile)
          imgLinks =
            "https://profnike.github.io/playstationImg/Playstation.png";
          setImgLink(imgLinks);
          console.log(imgLink);
          console.log(packageFile);
        });
  ...
  function subscribe() {
    localStorage.setItem(
      ...
      JSON.stringify({
        ...
        subCategory: named,
        autoRenew: subscription.Renewal,
  ...
  function Addlist() {
    ...
    axios
      .post(`${baseURL}/users/subscription`, userObject)
      .then((res) => {
        console.log(res);
      })
      .catch((err) => {
      ...
      <div className="newsub-web">
        ...
        >
          <div className="newsubContainer">
            ...
            <Belowbox
              icon={image.val}
              firstbutn={"ADD TO LIST"}
              noclick={() => {
                alert("none");
              }}
              firstclick={Addlist}
              product={packageFiles}
              secondbutn={"SUBSCRIBE"}
...
const mapstatetoprops = ({
  flex: { presentcolor, customer, subscription, subarray },
}) => ({
  presentcolor,
  customer,
  subscription,
