    ...
    <>
      <div className="Blog">
        ...
        <div className="blog-card-except">
          <h3 className="header-except-blog">
            Omdia foreCasts cloud gaming to nudge $12bn by 2026
          </h3>
          <div className="image-div-header-img">
          ...
          <div className="blog-card-except-below">
            <p>Tina Lawal</p> <p>02 Dec</p>
          </div>
        </div>
        <div className="blogs">
          {data.map((data, index) => (
        ...
        <div className="lower-blog-except">
          <div className="image-lower-except-div">
