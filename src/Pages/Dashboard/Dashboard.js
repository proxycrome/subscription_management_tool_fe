        ...
        >
          <div className="inner-body-dashboard">
            ...
            <div className="third-line-dashboard">
              <div className="third-line-dashboard-upper">
                <h3>Overview</h3>
              </div>
              ...
              <div className="fourth-line-dashboard-inner">
                <div className="fourth-line-left">
                  <div className="fourth-line-left-content">
                    <div>
                      <p className="subOverview">Subscription overview</p>
                    </div>
                    <div>
              ...
              .map((val, index) => {
                ...
                return (
                  <div className="catresult" key={index}>
                    ...
                    >
                      <Smallestbox className="excIcon" icon={itemImg} />
                      <p>{cats}</p>
                    </span>
