    ...
    <div className="signintotal">
            ...
            <div className="inner-input-section">
              <div className="pols">
                <div>
                  ...
                  <div className="email-wrapper">
                    <input
                      ...
                      value={email}
                      onChange={(e) => {
                        signindetails({ [e.target.name]: e.target.value });
                  ...
                  <div className="forgot-and-remember">
                    <span className="keep-logged-in">
                      ...
                      />
                      <label for="logedIn" className="remem-p">
                        Remember me
                      </label>
                    </span>
                    <Link className="forgot" to="/passwordReset">
                  ...
                  <div className="alternateSignin">
                    ...
                    <button className="facebook">
                      <FacebookLogo className="faceLogo" />
                      FACEBOOK
                    </button>
                  </div>
                </div>
                <p className="noAccount">
                  ...
                  <Link to="/signup" className="noAccount-signup">
                    Sign up
                  </Link>
                </p>
              </div>
      ...
      <div className="mobilesignin">
        ...
        <div className="signinmobile-inner">
          ...
          <button className="create" style={butnstyle} onClick={handlesignin}>
            {loading ? (
              <p style={logtext}>LOG IN</p>
            ) : (
              <div className="spinner-signin">
...
const mapstatetoprops = ({
  flex: { signininput, detailssignin, customer },
}) => ({
  signininput,
  detailssignin,
  customer,
