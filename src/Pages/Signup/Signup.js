        ...
        axios
          ...
          .then((res) => {
            ...
            if ((details.email && details.password) !== "") {
              if (remember === true) {
                if (
                  ...
                  localStorage.setItem(
                    "userPassword",
                    JSON.stringify(details.password)
                  );
                } else {
                  localStorage.setItem(
                    "userEmail",
            ...
            if (res.data.status === "success") {
              ...
              axios
                .post(`${baseURL}/users/wallet`, walletparams)
                .then((res) => {
                  console.log(res);
                });
    ...
    <div className="signup-total">
      <div className="signup">
        ...
        <div style={popupInfo} className="check-issue">
          <div
            className="cancel-confirm-signup"
            onClick={() => {
              setPopupInfo({ display: "none" });
            }}
          >
            <Cancel />
          </div>
        ...
        <div className="inner-signup">
          <div className="signup-textandimage">
            <div className="signup-textandimage-logo">
              <FlexLogo
            ...
            <div>
              ...
              <p>
                All-in-one subscription management platform. Keep track of your
                expenses, set auto-renewal on subscription and pay easily with
                Flex
              </p>
            </div>
          </div>
            ...
            <div className="signup-pols">
              ...
              <div className="select-div">
                <select
                  ...
                  onChange={(e) => {
                    signupdetails({ [e.target.name]: e.target.value });
                    setCountrystyle({ color: "black" });
                    setCountryval(e.target.value);
                  }}
                >
                  <option value="countryval" className="select-placeholder">
                    Country
                  </option>
              ...
              <div style={PasswordWrap} className="signup-password-wrapper">
                ...
                <i onClick={handletoggle}>
                  <FaEye
                    style={
                      passwordshow ? { display: "none" } : { display: "inline" }
                    }
                  />
                  <FaEyeSlash
                    style={
                      passwordshow ? { display: "inline" } : { display: "none" }
                    }
                  />
                </i>
              </div>
              <div style={passwordCharacter} className="password-charac">
                ...
                <p className="passwordcond">
                  Password should not be less than 8 characters and must include
                  caps,numbers and special characters
                </p>
              </div>
         ...
         render="explicit"
           ...
           verifyCallback={verifystate}
            ...
            /> */}
              ...
              >
                {loading ? (
                  <p style={logtext}>CREATE ACCOUNT</p>
                ) : (
                  <div className="spinner-signin">
                    {" "}
                    <Loader type="Oval" width={20} color="#000000" />
                  </div>
                )}
              </button>
              <div className="terms">
                <div className="signup-remember-me">
                  ...
                  <div className="terms-and-policy">
                    <p>
                      ...
                      <Link to="" className="Terms-and-condition">
                        {" "}
                        Terms and Conditions
                      </Link>
                      . See <Link className="privacy">Privacy Policy</Link>
                    </p>
                  </div>
                </div>
              </div>

              <div className="signup-orandline">
                {" "}
              ...
              <div className="google-AND-facebook">
                <button className="signup-google">
                  <GoogleLogo className="logoGoogle" />
                  <p> GOOGLE</p>
                </button>
                <button className="signup-facebook">
                  {" "}
                  <FacebookLogo className="logoFace" />
                  <p> FACEBOOK</p>
                </button>
              </div>
              ...
              <p className="already-have-account">
                ...
                <Link to="/signin" className="already-have-account-log">
                  Log in
                </Link>
              </p>
            </div>
      ...
      <div className="signup-mobile">
        ...
        ;setPassval(e.target.value)}}
          ...
          <div className="google-AND-facebook-mobile">
            <button className="signup-google-mobile">
              <GoogleLogo className="logoGoogle" />
              <p> GOOGLE</p>
            </button>
            <button className="signup-facebook-mobile">
              {" "}
              <FacebookLogo className="logoFace" />
              <p> FACEBOOK</p>
            </button>
