...
const Profile = ({
  ...
  const handleSubmit = (e) => {
    ...
    axios
      .patch(`${baseURL}/users/edit/${id}`, params)
      .then((res) => {
    ...
    <>
      <div className="mobile-and-web-settings">
        <div className="web-setings-view">
          <DashFrame
            dashSettingsStyle={{
              backgroundColor: presentcolor.dashheadercolor,
            }}
          >
            <div className="inner-settings-section">
              ...
              <div className="sub-header">
                <Link
                  to={`/settings/profile/${userStr.id}`}
                  style={{
                        ...
                        <input
                          ...
                          onChange={async (event) => {
                            ...
                            const res = await fetch(
                              "https://api.cloudinary.com/v1_1/proxycrome01/image/upload",
                              {
                                method: "POST",
                                body: data,
                              }
        ...
        <div className="mobile-setings-view">
          ...
          >
            ...
            <div className="sub-headers">
              ...
              >
                <p style={{ marginRight: "0" }}>Profile</p>
              </Link>
              <Link to="/settings/notifications">
                <p>Notifications</p>
              </Link>
