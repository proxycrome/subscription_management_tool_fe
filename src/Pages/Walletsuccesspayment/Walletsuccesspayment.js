...
function Walletsuccesspayment({ subscription, editarray }) {
  ...
  useEffect(() => {
    ...
    if (resVal.Hidy != "") {
      axios
        .patch(`${baseURL}/users/subscription/${clientIds}`, newObject)
        .then((res) => {
          console.log(res);
          ...
          axios
            ...
            .then((res) => {
              ...
              axios.patch(`${baseURL}/users/wallet`, paramval).then((res) => {
                console.log(res);
              });
            })
            .catch((err) => {
      ...
      //let userObject={}
      axios.post(`${baseURL}/users/subscription/`, userObject).then((res) => {
        console.log(res);
        //    localStorage.removeItem(clientRes)
        axios
          .get(`${baseURL}/users/wallet`)
  ...
  return (
    <div className="paymentsuccess">
      <div className="payment-inner">
        ...
        <Link to="/Dashboard" className="return-home">
          BACK TO HOME
        </Link>
      </div>
    </div>
