...
function Payment({ presentcolor, headercolor, subarray }) {
  ...
  useEffect(() => {
    ...
    axios
      .get(`${baseURL}/users/subscription`)
  ...
  return (
    <div className="paymentdashtotal">
      <div className="webDashboard">
        <DashFrame
          dashPaymentStyle={{ backgroundColor: presentcolor.paymentcolor }}
        >
            ...
            <div className="third-line-dashboard">
              ...
              <div className="third-line-dashboard-inner">
                ...
                <div className="selected-placeholder-below-div">
                  <select
                    name="choice"
                    className="selected-placeholder-below"
                    id="select-payment-below"
                  >
                  ...
                  <div className="fourth-line-left-content">
                    ...
                    <div>
                      <div className="upperleftCOntent">
                        ...
                        <p
                          className="accountId-upperbox"
                          style={{ color: "red" }}
                        >
                          Account ID: {customerDetail.userId}
                        </p>
                        <h3>
                          Customer Name: {customerDetail.firstName}{" "}
                          {customerDetail.lastName}
                        </h3>
                        <div
                          className="upperleft-and-icon"
                          style={
                            typeof customerDetail.phone !== "number"
                              ? { display: "none" }
                              : { display: "flex" }
                          }
                        >
                  ...
                  <div className="WALLET-div">
                    <div className="wallet">
                      <div className="wallet-upper">
                        ...
                        <p className="medium-weight-dashboard"></p>
        ...
        <div className="binDiv" onClick={(()=>{handledelete(index)})} style={itemStatus=="" ? {display:"none"}:{display:"flex"}}><img src={Bin}/></div>
            ...
            {arr
              ...
              .map((val, index) => {
                ...
                return (
                  <div className="catresult" key={index}>
                    <span
      ...
      <div className="mobile-dashboard-All">
        <MobileDash
          dashheaderstyle={{ backgroundColor: presentcolor.dashheadercolor }}
        >
          <div className="mobile-dashboard">
            ...
            <div>
              <div className="inner-mobile-dashboard">
                ...
                <div className="mobilecard-in-Dashboard">
                  <Mobilecard />
                </div>
              </div>
              <div className="mobile-graph-dashboard">
                <div className="fourth-line-left-content">
                  <div className="upperleftCOntent">
                    <h2>PERSONAL INFORMATION</h2>
                    <hr className="customer-info-line" />
                    <p className="accountId-upperbox" style={{ color: "red" }}>
                      Account ID: {customerDetail.userId}
                    </p>
                    <h3>
                      Customer Name: {customerDetail.firstName}{" "}
