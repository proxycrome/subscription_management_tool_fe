  ...
  const submit = (e) => {
    ...
    if (passval.match(decimal)) {
      if (password === passwordsecond) {
        axios
          .put(`${baseURL}/resetpassword`, params)
          .then((res) => {
    ...
    <div className="reset-pass-all">
      <div className="web-reset-pass">
        <Resetpassframe>
           ...
           <input type="email" placeholder="Password"/>
              ...
              <div className="password-wrapper-reset" style={PasswordWrap}>
                <input
                  ...
                  value={password}
                  onChange={(e) => {
                    passwordreset({ [e.target.name]: e.target.value });
          ...
          <p className="remember-passreset-pass">
            Remember your password{" "}
            <Link to="/signin" className="link-rem-passreset">
              Sign in
            </Link>
          </p>
        </Resetpassframe>
...
const mapstatetoprops = ({
  flex: { signininput, detailssignin, forgotpassword },
}) => ({
  signininput,
  detailssignin,
  forgotpassword,
