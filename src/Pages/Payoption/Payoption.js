              ...
              <div className="payment-inner-content">
                ...
                <div className="image-and-option-payment">
                  ...
                  <div className="payment-option-buttons">
                    ...
                    >
                      <Paycard className="payment-option-icon" />
                      PAY WITH CARD
                    </button>
                    <button
                      style={butnbordersecond}
                      onClick={() => {
                        if (click == false) {
                    ...
                    >
                      <Paywallet className="payment-option-icon" />
                      PAY WITH E-WALLET
                    </button>
                  </div>
                </div>
                <div className="payment-select-buttons">
                  <button onClick={history.goBack} className="cancel-payment">
                    CANCEL
                  </button>
                  <button
                    onClick={() => {
      ...
      <div className="pay-mobile-views">
        <MobileDash>
          <div className="mobile-option-payMent">
            ...
            <div>
              <p className="parag-option">
                {" "}
                Please select your preffered payment option
              </p>
              <div>
              ...
              <div className="cance-proceed-mobile">
                <button
                  ...
                  className="cancel-payment  second-cancel-button"
                >
                  CANCEL
                </button>
                <button
