        ...
        <div className="Bodyinner">
          <div className="Innercontent-original">
            <div className="contents-original">
              <h2 className="content-orig-h">
                Subscription Management Made Easy!
              </h2>
              <p>
                Flex is a subscription management platform that allows you to
                manage multiple subsription plans. It gives you the freedom to
          ...
          <div className="Innercontent">
            ...
            <div className="contents">
              ...
              <p>
                Managing and keeping track of multiple subscriptions could be
                tedious. With Flex, you need not worry about that as all
          ...
          <div className="Innercontent" id="pat-div">
            ...
            <div className="contents">
              <h2>Our Partners</h2>
              <p>
                We build trust and confidence with our partners by being one of
                the first brands to create a well secured payment platform with
                some of the best companies recognized globally.{" "}
              </p>
          ...
          <div className="love">
            ...
            <p>
              Learn why over 1000 people trust Flex to power their complex
              billing and financial operations.
            </p>

            <div className="customer-love-img">
              ...
              <div className="blog-div-show">
                <div className="blog-content">
                  ...
                  <div className="below-img-blog">
                    ...
                    <p className="below-img-blog-p">
                      Just the management and insight alone got us a long way...
                    </p>
              ...
              <div className="blog-div">
                <div className="blog-content">
                  ...
                  <div className="below-img-blog">
                    ...
                    <p className="below-img-blog-p">
                      Subscription-based saaS application and licensing makes
                      utilizing..
                    </p>
                    <span className="blog-innermost">
                      <div className="blog-landing-profile">
