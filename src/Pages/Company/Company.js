  ...
  return (
    <div className="comPany">
      <div>
        <Navbar
          compstyle={{
            color: presentcolor.companycolor,
            paddingBottom: "0",
            marginBottom: "0",
          }}
          aboutstyle={{
            color: presentcolor.aboutcolor,
            textDecoration: "none",
          }}
        ...
        <div>
          ...
          <div className="company-provide">
            ...
            <div className="provide-left-center">
              <h3>
                We are experts in our field and are able to transform and
                provide subscription services , integrated payment methods and
                wide range of subscription management.
              </h3>
              <p>
                Over the past decade, Flex has expanded its offerings to address
                the complexities of Recurring billing and Subscription
                Management.{" "}
              </p>
            </div>
          </div>
          <div className="company-how">
            <div className="company-how-left">
              ...
              <div className="abouty-div" id="mobile-abouty-div">
                <img src={abouty} />
              </div>
              <div className="company-doing">
                <div className="company-doing-content" id="marginExtra">
                  ...
                  <div>
                    ...
                    <p className="textABout"> Partners</p>
                  </div>
                </div>
                <div className="company-doing-content" id="marginExtraSecond">
                  <div id="marginExtraX">
                    <p className="numberAbout">20</p>
                    <p className="textABout"> Smart Working People</p>
                  </div>

                  <div>
                    <p className="numberAbout">40k+</p>
                    <p className="textABout"> Subscriptions under management</p>
                  </div>
                </div>
              </div>
            </div>
            <div className="abouty-div" id="web-abouty-div">
              <img src={abouty} />
            </div>
          </div>
          <div className="company-about">
            <div className="about-us">
              ...
              <div>
                <p>
                  ...
                  customer service ethos to solve real-world problems and is
                  committed to becoming the operating system for your
            ...
            <div className="imagesDivs">
              <div className="image-One">
                <div className="shaped-image-div">
                  <img src={image5} />
                </div>
                <div className="shaped-image-div">
                  <img src={image} />
              ...
              <div className="image-Three">
                <div className="shaped-image-div-first">
                  <img src={image3} />
                </div>
                <div className="shaped-image-div">
                  <img src={image2} />
