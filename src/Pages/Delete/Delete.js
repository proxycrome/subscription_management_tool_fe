...
function Delete({ match }) {
  ...
  function handleDelete() {
    ...
    axios.delete(`${baseURL}/users/subscription/${num}`).then((res) => {
      console.log(res);
    ...
    <div className="logout">
      <div className="logout-inner">
        ...
        <div className="LOGOUT-BUTTON">
          <button onClick={history.goBack} className="logout-first-button">
            CANCEL
          </button>
          <button onClick={handleDelete} className="logout-second-button">
            DELETE
          </button>
        </div>
      </div>
