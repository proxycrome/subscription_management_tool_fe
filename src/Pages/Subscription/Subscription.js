...
function Subscription({ presentcolor, headercolor, subarray }) {
  ...
  useEffect(() => {
    ...
    axios.get(`${baseURL}/users/subscription`).then((res) => {
  ...
  return (
    <div>
      <div className="subscribewebscreen">
        <DashFrame
          dashsubscribestyle={{
            backgroundColor: presentcolor.dashsubscribecolor,
          }}
        >
          <div className="subSCRiption">
            ...
            <div className="mysubsribe-and-button">
              ...
              <button
                ...
                className="subSCRIPTION-pluslogo"
              >
                <PlusLogo />
                ...
                <div className="pieInner">
                  <div className="header">
                    ...
                    >
                      ...
                      <Calendar /> <p className="calendar">{ansDate}</p>
                    </span>
                    {/* <div className='links'>
        <a
              ...
              <div className="card-and-activity">
                <div className="card-in-subscribe">
                  <div className="cardImage-subscribe">
                    <div className="cardImage-acc-subscribe">
                      <p>Account Id</p>
                      <p className="medium-weight-dashboard">
                ...
                <div className="activity-subscribe">
                  ...
                  <div className="subscription-circle-and-text-div">
                    ...
                    <div className="subscription-circle-and-text">
                      <div
                        className="subscription-circle"
                        id="subscription-circle-green"
                      >
                        {activ}
                      </div>
                      <p>Active </p>
              ...
              {arr
                .filter((val, index) => {
                  ...
                  if (searchDatar === "") {
                    ...
                    val.subCategory
                      .toUpperCase()
                      .includes(searchDatar.toUpperCase())
                  ) {
                    return val;
                  }
                })
                ...
                .map((val, index) => {
                  ...
                  return (
                    <div className="catresult-sub" key={index}>
                      <span
                        className="Product-and-Pname"
                        style={
                          itemStatus == ""
                            ? { display: "none" }
                            : { display: "flex" }
                      ...
                      <span>
                        <p style={{ color: "rgba(51,51,51,50%" }}>
                          {val.dateExpired}
                        </p>
                      </span>
                      ...
                      <span style={{ color: colours.coloritem }}>
                        {itemStatus}
                      </span>
                      ...
                      >
                        <p
                          onClick={() => {
                            ...
                            if (val.subscriptionStatus == "Expired") {
                              Expired(val, index);
                            }
                          }}
                          style={
        ...
        >
          ...
          <div className="subscribemobilescreen-inner">
            <div className="subscribemobilescreen-second">
              ...
              <button
                ...
                className="subSCRIPTION-pluslogo-mobile"
              >
          ...
          <div className="piemobile">
            <div className="header">
              ...
              >
                {" "}
                <p style={{ marginRight: "30px" }}>Monthly Subscription</p>{" "}
                <p className="calendar">{ansDate}</p>
              </span>
              {/* <div className='links'>
        <a
          className='btn btn-gh'
          ...
          <div className="activity-subscribe">
            ...
            <div className="subscription-circle-and-text-div">
              ...
              <div className="subscription-circle-and-text">
                <div
                  className="subscription-circle"
                  id="subscription-circle-green-mobile"
                >
                  {activ}
                </div>
                <p>Active </p>
              ...
              <div className="subscription-circle-and-text">
                <div
                  className="subscription-circle"
                  id="subscription-circle-ash-mobile"
                >
                  {inactiv}
                </div>
                <p>Inactive </p>
              ...
              <div
                className="subscription-circle-and-text"
                style={{ border: "red" }}
              >
                <div
                  className="subscription-circle"
                  id="subscription-circle-red-mobile"
                >
                  {expiredval}
                </div>
                <p>Expired </p>
