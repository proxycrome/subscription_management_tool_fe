    ...
    <DashFrame>
      ...
      <div className="Pinverification">
        ...
        <div className="image-pin-input">
          <div className="authenticate-image-div">
        ...
        <div className="pinverification-button">
          <button className="cancel-action" onClick={history.goBack}>
            CANCEL
          </button>
          <button className="confirm-action" onClick={handleconfirm}>
            CONFIRM
          </button>
        </div>
      </div>
