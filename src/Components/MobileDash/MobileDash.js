    ...
    <div className="top-mobile-dash-nav">
          ...
          <div className="list">
            ...
            <div
              onClick={() => {
                ...
                setLeftNav({ display: "none" });
              }}
              style={dashsubscribestyle}
              className="inner-list"
            >
              <div className="dash-icon">
                <Sub />
            ...
            <div
              onClick={() => {
                setLeftNav({ display: "none" });
                history.push(`/settings/profile/${userStr.id}`);
              }}
              style={dashSettingsStyle}
              className="inner-list"
            >
              <div className="dash-icon">
                <Settingssvg />
            ...
            <div
              className="inner-list"
              style={dashSupportStyle}
              onClick={() => {
                setLeftNav({ display: "none" });
                history.push("/support/faq");
              }}
            >
              <div className="dash-icon">
                <Supportsvg />
      ...
      <div className="mobileDashtotal" style={rightNav}>
        ...
        <div className="mobile-dash-header">
          <div
            className="mobile-dash-header-left"
            onClick={() => {
              setLeftNav({ display: "flex" });
              setRightNavbar({
          ...
          >
            <FaBars />
            <div className="mobile-dash-logo">
              <img src={flexpng} />
            </div>
          </div>
        ...
        <div className="mobile-dash-lower">
          ...
          <div className="profile-avatar">
            {typeof customerDetail.photo === "string" ? (
              <img src={customerDetail.photo} />
            ) : (
              <FaUserAlt />
            )}
          </div>
